            ...
            <?php } else { ?>
                <div id="hero-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
                    <div class="carousel-inner">
                        <?php
                        // 獲取可見的英文輪播圖片
                        $carousel_sql = "SELECT * FROM carousel_images WHERE language = 'en' AND is_visible = 1 ORDER BY sort_order";
                        $carousel_result = $conn->query($carousel_sql);
                        $first = true;
                        while ($image = $carousel_result->fetch_assoc()):
                            ?>
                            <div class="carousel-item <?php echo $first ? 'active' : ''; ?>">
                                <img src="/series_lecture/<?php echo $image['image_path']; ?>" class="d-block w-100" alt="">
                            </div>
                            <?php
                            $first = false;
                        endwhile;
